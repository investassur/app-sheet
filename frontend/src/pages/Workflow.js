    ...
    <div className="min-h-screen bg-gray-50 font-sans" style={{ fontFamily: 'Inter, Nunito, sans-serif' }}>
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-10 py-6 flex flex-col md:flex-row md:items-center md:justify-between shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-extrabold text-gray-800 tracking-tight ml-4">Workflow Prospect</h1>
        </div>
      ...
      <div className="px-10 py-8 max-w-7xl mx-auto">
        {section === 'workflow' && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Gestion du Workflow</h2>
            <div className="bg-white rounded-xl shadow p-8 border border-gray-100">
              <div className="mb-3"><span className="font-semibold">Statut du workflow :</span> <span className="text-violet-700">À implémenter</span></div>
              <div className="mb-3"><span className="font-semibold">Étapes :</span> <span className="text-gray-400">À intégrer : visualisation et gestion des étapes du workflow</span></div>
              <div className="mb-3"><span className="font-semibold">Actions :</span> <span className="text-gray-400">À intégrer : actions sur le workflow (avancer, relancer, etc.)</span></div>
            </div>
          </section>
        )}
        {section === 'contact' && (
        ...
        {section === 'contrats' && (
          <section className="mb-12">
            ...
            <div className="bg-white rounded-xl shadow p-8 border border-gray-100">
              <div className="text-gray-400 italic">À intégrer : liste des contrats</div>
            </div>
          </section>
        )}
        {section === 'historique' && (
